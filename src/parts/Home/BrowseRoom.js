...
export default function BrowseRoom() {
  const {data, status, error, run, isLoading} = useAsync({data: {username: "Hello"}})

  useEffect(() => {
    run(
      fetch(
        "https://5346e9fa-0021-4e47-b44e-96655a9388c5.mock.pstmn.io/api/categories/?page=1&limit=4"
      ).then(async response => {
