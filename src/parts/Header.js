          ...
          <div className="w-auto">
            ...
            >
              <li className="mx-3 py-6 md:py-0">
                <Link to="/showcase" className={["hover:underline", theme === 'light' ? "text-black md:text-white" : "text-white md:text-black"].join(" ")}
                  >Showcase</Link>
              </li>
              <li className="mx-3 py-6 md:py-0">
                <Link to="/catalog" className={["hover:underline", theme === 'light' ? "text-black md:text-white" : "text-white md:text-black"].join(" ")}
                  >Catalog</Link>
              </li>
              <li className="mx-3 py-6 md:py-0">
                <Link to="/delivery" className={["hover:underline", theme === 'light' ? "text-black md:text-white" : "text-white md:text-black"].join(" ")}
                  >Delivery</Link>
              </li>
              <li className="mx-3 py-6 md:py-0">
                <Link to="/rewards" className={["hover:underline", theme === 'light' ? "text-black md:text-white" : "text-white md:text-black"].join(" ")}
                  >Rewards</Link>
              </li>
            </ul>
          </div>
          <div className="w-auto">
            <ul className="items-center flex">
              ...
              <li className="ml-6">
                <Link
                  id="header-cart"
                  className={["hover:underline", theme === 'light' ? "text-black md:text-white" : "text-white md:text-black"].join(" ")}
                  to="/cart"
                >
                  <svg
                    className="fill-current"
